#!/bin/bash
# This script is a wrapper around `github_changelog_generator` (https://github.com/github-changelog-generator)
...
function print_usage() {
    cat <<EOF
Usage: $0 [-h|--help] [-f|--full] [--release-branch <branch>] [--since-tag <tag>] [--future-release <tag>] [-t|--token <token>]
